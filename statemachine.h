...
callback_t property_set_value_state(MetaConfiguration& conf, std::ifstream& f, int& error);

/* finishes the handling of the property. */
callback_t end_property_set_state(MetaConfiguration& conf, std::ifstream& f, int& error);
